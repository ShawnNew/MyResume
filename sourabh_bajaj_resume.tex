...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://chenxiaoniu.com/}{\Large Chenxiao Niu}} & Email : \href{niuc@mcmaster.ca}{niuc@mcmaster.ca}\\
  \href{http://chenxiaoniu.com/}{http://www.chenxiaoniu.com} & Mobile : +1-905-923-6358 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Electrical \& Computer Engineering;  GPA: 4.00}{Sep. 2017 -- Present}
    \resumeSubheading
      {Beijing University of Posts and Telecommunications}{Beijing, China}
      {Bachelor of Electronic Information Engineering;  GPA: 3.66 (9.15/10.0)}{Sep. 2013 -- Jun. 2017}
