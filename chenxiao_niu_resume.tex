...
\section{Qualifications}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Teamwork}
      {Gained excellent teamwork and communication skills through the half-year internship at BMW China.}
...
\section{Skills \& Courses}
  \resumeSubHeadingListStart
    \item{
      \textbf{Skills}{: Java, Python, C++, Linux, Git, TensorFlow, SQL, MATLAB, HTML, CSS and JavaScript}}
      \item{
